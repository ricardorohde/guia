...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['uploaded_too_big_ini']        = 'Erro ao fazer Upload (o tamanho do arquivo excede a diretiva upload_max_filesize no php.ini de seu servidor).<br> Solicite ao seu provedor de hospedagem que aumente o limite dessa diretiva!';
        ...
        $this->translation['uploaded_cant_write']         = 'Erro ao fazer Upload (falha ao gravar no disco).';
