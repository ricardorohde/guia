 ...
 * Data: 08/2014
 */
class Gcategoria extends GcategoriaModel {
    ...
    //método principal da classe - exibe gcategorias cadastradas
    public function indexController() {
        //defina a url base da paginacao
        $this->db->url = Router::base() . "/painel/gcategoria";
        ...
        $this->tpl->tpl('admin/gcategoria.phtml')
    ...
    public function atualizar() {
        ...
        Router::redirect("$this->baseuri/painel/gcategoria/ok-now/");
    }
