 ...
 * Data: 08/2014
 */
class Ncategoria extends NcategoriaModel {
    ...
    //método principal da classe - exibe ncategorias cadastradas
    public function indexController() {
        //defina a url base da paginacao
        $this->db->url = Router::base() . "/painel/ncategoria";
        ...
        $this->tpl->tpl('admin/ncategoria.phtml')
    ...
    public function atualizar() {
        ...
        Router::redirect("$this->baseuri/painel/ncategoria/ok-now/");
    }
