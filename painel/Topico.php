 ...
 * Data: 08/2014
 */
class Ntopico extends TopicoModel {
    ...
    //método principal da classe - exibe topicos cadastradas
    public function indexController() {
        //defina a url base da paginacao
        $this->db->url = Router::base() . "/painel/topico";
        //define 25 itens por pagina
        $this->db->paginate(25);
        //tpl->data é enviado ao template topico.html para listagem no foreach
        $this->tpl->data = $this->getAllCategoria();
        //seleciona o arquivo template phtml e repassa com assign os links da paginacao (db->pages)
        $this->tpl->tpl('admin/topico.phtml')
    ...
    public function atualizar() {
        ...
        Router::redirect("$this->baseuri/painel/topico/ok-now/");
    }
